"""
This module contains the implementation of the Hypaspist unit in the game.
"""
...
class Hypaspist(BaseUnit):
    ...
    def __init__(self, initial_position, player, formation="Standard"):
        ...
        sprite_dir = os.path.join('..', 'assets', 'sprites', 'units', 'hypaspist')
    ...
    def can_move_to(self, position, board, all_units):
        ...
        """
        Check if the Hypaspist can move to a given position.

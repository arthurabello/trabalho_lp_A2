"""
This module contains the implementation of the Legionary unit in the game.
"""
...
class Legionary(BaseUnit):
    ...
    def __init__(self, initial_position, player, formation="Standard"):
        ...
        sprite_dir = os.path.join('..', 'assets', 'sprites', 'units', 'legionary')
    ...
    def can_move_to(self, position, board, all_units):
        ...
        """
        Check if the Legionary can move to a given position.
    ...
    def attack(self, target, board=None):
        ...
        try:
            ...
            print(f"Failed to play attack sound in units/legionary: {str(e)}")

    def can_attack(self, target_position):

        """
        Check if this legionary can attack a position.
